...
public class BookConstants {
    ...
    public static final String GET_ALL_SUMMARY = "Get all books optionally with pagination "
            + "and sorting";
    ...
    public static final String CREATE_BOOK_DESCRIPTION = "Creates a new book according to the "
            + "entity provided";
    public static final String UPDATE_BOOK_SUMMARY = "Update an existing book";
    public static final String UPDATE_BOOK_DESCRIPTION = "Updates an existing book according "
            + "to the entity provided";
    public static final String DELETE_BOOK_SUMMARY = "Delete an existing book";
    public static final String DELETE_BOOK_DESCRIPTION = "Deletes an existing book according to"
            + " the id provided";
    public static final String VALID_ID_DESCRIPTION = "Book id, must exist in DB and"
            + " be greater than 0";
