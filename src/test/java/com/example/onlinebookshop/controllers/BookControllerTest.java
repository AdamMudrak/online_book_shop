...
public class BookControllerTest {
    ...
    static void initVars(@Autowired WebApplicationContext webApplicationContext) {
        ...
        CREATE_NEW_BOOK_DTO.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
        ...
        EXPECTED_NEW_BOOK_DTO.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
        ...
        CREATE_EXISTING_BOOK_DTO.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
        ...
        EXPECTED_BOOK_DTO_AFTER_UPDATE.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
        ...
        EXPECTED_GATSBY_BOOK_DTO.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
        ...
        EXPECTED_TKAM_BOOK_DTO.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
        ...
        EXPECTED_1984_BOOK_DTO.setCategoryIds(Set.of(FICTION_CATEGORY_ID));
    ...
    public void getAll_IsAbleToGetThreeBooksInTwoPortionsDueToPageSizeLimit_Success()
            throws Exception {
